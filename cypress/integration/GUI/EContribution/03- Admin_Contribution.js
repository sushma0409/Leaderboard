...
describe('Contribution feature for Admin',function(){
    it('LB-92 : As Admin, user should able to add contribution',function(){
        ...
        cy.wait(1000)
        cn.AddContribution()
        fy.ContributionType('Open source')
        fy.Title('Testing')
        fy.ContributionDate('2022-04-16')
        fy.Technology('Selenium')
        fy.UrlDetail()
        fy.Submit()
        cy.get('.ng-trigger').should('contain','Successfully added contribution!')
        cy.wait(1000)
    })
    it('LB-99 : As Admin, user is able to view his contributions',function(){
        const page = new Dashboard()
        const menu = new Menu()
        const cn = new Contribution()
        page.Admin()
    ...
    it('LB-109 : As Admin, user should able to edit his own contribution',function(){
        const page = new Dashboard()
        const menu = new Menu()
        const cn = new Contribution()
        const fy = new AddContribution()   
        ...
        cn.Edit()         
        fy.Title('Title')                                                             
        fy.Technology('Devops')
        fy.Submit()
        cy.get('.ng-trigger > .ng-tns-c18-0').should('have.text',' Updated Successfully!!!! ')
    })
    it('LB-102 : As Admin, user should able to approve/reject contribution',function(){
        const page = new Dashboard()
        const menu = new Menu()
        const cn = new Contribution()  
        page.Admin()
    ...
    it('LB-119 : As Admin, user should able to view all contributions across Knoldus',function(){
        const page = new Dashboard()
        const menu = new Menu()
        const cn = new Contribution()
        page.Admin()
